...
(function(global) {
    ...
    class PackDisplay {
        ...
        renderPackDetail(packId) {
            ...
            this.currentManagingPackId = packId; // Ensure current pack ID is set
            if (global.window) global.window.currentManagingPackId = packId; // Update global one too for now
